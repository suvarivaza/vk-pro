...
class Controller_State_Admin_Start extends Controller_State_Admin
{
    private $_text = '';
    ...
    public function actionPrepare()
    {
        ...
        $this->_text = file_get_contents(Model_Config::$autoStartPath);
    ...
    public function actionGet()
    {
        ...
        return $this->_response->setBody(\STPL::Fetch('admin/start', $vars));
    }
    ...
    private function _save()
    {
        ...
        file_put_contents(Model_Config::$autoStartPath, $this->_text);
