    ...
    <div class="page_block">
                    ...
                    <?php foreach ($emoji as $emojiList): ?>
                        ...
                        <?php foreach ($emojiList['texts'] as $text => $code): ?>
                            <a href="javascript:void(0)"
                               onclick="posting.emojiAdd('<?= $code; ?>', <?= $post->postId; ?>)">
            ...
            <div class="row form-group">
                ...
                <div class="col-sm-5">
                    ...
                    <span class="input-group-addon" id="basic-addon1">
                        ...
                        <input id="i_post_date<?= $post->postId; ?>" name="postDate" type="text"
                               class="datepicker form-control" placeholder="Дата публикации"
                ...
                <div class="col-sm-4">
                    <table style="width: 100%;">
                        <tr>
                            <td style="width: 50%;">
                                <select id="i_hour<?= $post->postId; ?>" name="hour" class="form-control">
                            ...
                            <td>:</td>
                            <td style="width: 50%;">
                                <select id="i_minute<?= $post->postId; ?>" name="minute" class="form-control">
                ...
                <div class="submit_post">
                    ...
                    <div class="row form-group">
                        ...
                        foreach ($poll['answers'] as $answer): ?>
                            <div class="col-sm-12">
                                ...
                                <input data-index="<?= $index; ?>" type="text" name="poll[<?= $index; ?>][answers][]"
                                       class="form-control c_poll_answer" value="<?= $answer; ?>">
                            </div>
                        ...
                        <div class="col-sm-12">
                            <label></label>
                            <input data-index="<?= $index; ?>" type="text" name="poll[<?= $index; ?>][answers][]"
                                   class="form-control" onclick="posting.addAnswer(this);"
        ...
        <div id="submit_post<?= $post->postId; ?>" class="submit_post">
            <div class="post_buttons">
                <button type="button" class="btn btn-primary pull-right" onclick="posting.addPost()">Сохранить</button>&nbsp;
                <button type="button" class="btn btn-default pull-right" style="margin-right: 10px;"
                        onclick="posting.cancelEditPost()">Отмена
                </button>&nbsp;
                ...
                <div class="c_div_icon c_tooltip_bottom" data-content="Добавить опрос" data-placement="bottom"
                     id="i_div_add_poll_<?= $post->postId; ?>" onclick="posting.addPoll();"><span
