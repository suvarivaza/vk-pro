        ...
        <div class="form-group">
            ...
            <div class="col-sm-6">
                <select class="form-control" name="hashtagsPos">
                    ...
                    <option value="1"<?php if ($group->hashtagsPos == 0): ?> selected="selected"<?php endif; ?>>В начале
                        поста
                    </option>
                </select>
            </div>
                    ...
                    <div class="col-sm-12">
                        <select class="form-control form-span c-watermark-param" id="i-watermark-param-watermarkSize"
                            ...
                            <?php foreach ($vars['sizes'] as $size): ?>
                                <option value="<?= $size; ?>"<?php if ($size == $group->watermarkSize): ?> selected="selected"<?php endif; ?>><?= $size; ?></option>
                            <?php endforeach; ?>
                        </select>
                    </div>
                </div>
