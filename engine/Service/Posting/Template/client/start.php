    ...
    <div class="row text-center">
        <div class="col-sm-12">
            ...
            <div class="main-posting-image">
                <img src="/img/main/posting.png" style="max-width: 100%;"/>
            </div>
            <div class="main-text">
                Мы знаем, что поиск и своевременная публикация контента в сообщество отнимает у администратора много сил
                и времени. Потому, для наших пользователей мы разработали Автопостинг, способный размещать материалы в
                вашем сообществе за вас. Вы можете создавать очередь из постов для своего сообщества на месяца вперед.
            </div>
        </div>
    </div>
</div>
...
<div class="row">
    <div class="col-sm-12 text-center">
        <button class="button-green" id="i_auto_button_add">Приобрести автопостинг</button>
        <?php if ($vars['isFree']): ?>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h5 class="modal-title" id="i_dialog_auto_add_label">Приобрести автопостинг</h5>
            </div>
            <div class="modal-body" id="i_dialog_auto_add_container">
                <form action="/orders/order" method="post">
                    ...
                    <h4 class="text-center">Приобрести автопостинг</h4>
