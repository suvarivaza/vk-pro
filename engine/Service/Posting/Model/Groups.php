...
{
    public const TABLE = 'posting_groups';
     ...
     * @return Model_Groups_Group[]
     */
    public function getByPostingId($postingId, $for_save = false)
    {
        $group = new  Model_Groups_Group($this);

        return parent::_getCollectionByIndex($postingId, $group, new \Database_Main(), self::TABLE,
