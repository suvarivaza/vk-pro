...
class Controller_State_Client_Penalty_Tasks extends Controller_State_Client
{
    ...
    public function actionGet()
    {
        ...
        $list = $this->factoryUsers->users->balance->getByUserIdIsTask($this->_application->UserID, true);
        $total = count($list);
        ...
        return $this->_response->setBody(\STPL::Fetch('client/penalty/tasks', $vars));
    }
