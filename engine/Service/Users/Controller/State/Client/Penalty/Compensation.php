...
class Controller_State_Client_Penalty_Compensation extends Controller_State_Client
{
    ...
    public function actionGet()
    {
        ...
        $list = $this->factoryUsers->users->balance->getByUserIdIsCompensation($this->_application->UserID, true);
        $total = count($list);
        ...
        return $this->_response->setBody(\STPL::Fetch('client/penalty/compensation', $vars));
    }
