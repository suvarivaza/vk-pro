...
<ul class="breadcrumb">
    ...
    <li>
        <a href="/tasks/special/<?= $group->groupId; ?>/all/1">
            <img class="img-circle" src="<?= $group->photo; ?>" width="30"/>
            <strong><?= \Lib_Text::Truncate($group->title); ?></strong>
        </a>
    </li>
    <li><strong>Добавить спецзадание</strong></li>
</ul>
<?php if ($vars['total'] < 300): ?>
    <div class="alert alert-danger">
        <h4>ВНИМАНИЕ!</h4>
        <p>Для успешного выполнения спецзданий необходимо <strong>не менее 300</strong> подписчиков.</p>
        <p>На текущий момент Вам не хватает <strong><?= 100 - $vars['total']; ?></strong> подписчиков.</p>
    </div>
<?php endif; ?>
<form id="i_form_task_add" action="" method="POST" enctype="multipart/form-data" target="_self" class="form-horizontal"
    ...
    <input type="hidden" id="i_form_task_add_taskId" name="taskId" value=""/>
    ...
    <?php foreach ($vars['types'] as $type): ?>
        <div class="c-tip-type" id="i-tip-type-<?= $type; ?>"
            ...
            <?= \STPL::IsTemplate('controls/special/' . $type) ? \STPL::Fetch('controls/special/' . $type) : ''; ?>
        </div>
        <?php foreach ($vars['vkTypes'] as $vkType => $title): ?>
            <div class="c-tip-vkType" id="i-tip-vkType-<?= $type; ?>-<?= $vkType; ?>" style="display: none;">
                <?= \STPL::IsTemplate('controls/special/' . $type . '_' . $vkType) ? \STPL::Fetch('controls/special/' . $type . '_' . $vkType) : ''; ?>
            </div>
        <?php endforeach; ?>
    <?php endforeach; ?>
    <?php if ($vars['errors']): ?>
    ...
    <div id="i_div_task_url" class="form-group">
        ...
        <div class="col-sm-1">
            <?php if ($tips['url-text']): ?>
                <label class="control-label c_tooltip" data-delay="<?= $tips['url-time']; ?>"
                       data-content="<?= $tips['url-text']; ?>"><img src="/img/icons/32/info.png"
    ...
    <div id="i_div_minKarma" class="form-group">
        ...
        <div class="col-sm-1">
            <?php if ($tips['minKarma-text']): ?>
                <label class="control-label c_tooltip" data-delay="<?= $tips['minKarma-time']; ?>"
                       data-content="<?= $tips['minKarma-text']; ?>"><img src="/img/icons/32/info.png"
                                                                          style="width: 14px; height: 14px;"/></label>
            <?php endif; ?>
        </div>
    </div>
    <div id="i_div_targeting_container">
        ...
        <div id="i_div_targeting" <?php if (!$task->targeting): ?>style="display: none;"<?php endif; ?>>
            <div class="form-group">
                ...
                <div class="col-sm-1">
                    <?php if ($tips['sex-text']): ?>
                        <label class="control-label c_tooltip" data-delay="<?= $tips['sex-time']; ?>"
                               data-content="<?= $tips['sex-text']; ?>"><img src="/img/icons/32/info.png"
                                                                             style="width: 14px; height: 14px;"/></label>
                    <?php endif; ?>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-1">
                    <?php if ($tips['age-text']): ?>
                        <label class="control-label c_tooltip" data-delay="<?= $tips['age-time']; ?>"
                               data-content="<?= $tips['age-text']; ?>"><img src="/img/icons/32/info.png"
                                                                             style="width: 14px; height: 14px;"/></label>
                    <?php endif; ?>
                </div>
            </div>
    ...
    continue;
                ...
                <div class="col-sm-1">
                    <?php if ($tips['city-text']): ?>
                        <label class="control-label c_tooltip" data-delay="<?= $tips['city-time']; ?>"
                               data-content="<?= $tips['city-text']; ?>"><img src="/img/icons/32/info.png"
                                                                              style="width: 14px; height: 14px;"/></label>
                    <?php endif; ?>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-1">
                    <?php if ($tips['relation-text']): ?>
                        <label class="control-label c_tooltip" data-delay="<?= $tips['relation-time']; ?>"
                               data-content="<?= $tips['relation-text']; ?>"><img src="/img/icons/32/info.png"
                                                                                  style="width: 14px; height: 14px;"/></label>
                    <?php endif; ?>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-1">
                    <?php if ($tips['avatarCount-text']): ?>
                        <label class="control-label c_tooltip" data-delay="<?= $tips['avatarCount-time']; ?>"
                               data-content="<?= $tips['avatarCount-text']; ?>"><img src="/img/icons/32/info.png"
                                                                                     style="width: 14px; height: 14px;"/></label>
                    <?php endif; ?>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-1">
                    <?php if ($tips['filled-text']): ?>
                        <label class="control-label c_tooltip" data-delay="<?= $tips['filled-time']; ?>"
                               data-content="<?= $tips['filled-text']; ?>"><img src="/img/icons/32/info.png"
                                                                                style="width: 14px; height: 14px;"/></label>
                    <?php endif; ?>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-1">
                    <?php if ($tips['pageAge-text']): ?>
                        <label class="control-label c_tooltip" data-delay="<?= $tips['pageAge-time']; ?>"
                               data-content="<?= $tips['pageAge-text']; ?>"><img src="/img/icons/32/info.png"
                                                                                 style="width: 14px; height: 14px;"/></label>
                    <?php endif; ?>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-1">
                    <?php if ($tips['followersCount-text']): ?>
                        <label class="control-label c_tooltip" data-delay="<?= $tips['followersCount-time']; ?>"
                               data-content="<?= $tips['followersCount-text']; ?>"><img src="/img/icons/32/info.png"
                                                                                        style="width: 14px; height: 14px;"/></label>
                    <?php endif; ?>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-1">
                    <?php if ($tips['interestingPage-text']): ?>
                        <label class="control-label c_tooltip" data-delay="<?= $tips['interestingPage-time']; ?>"
                               data-content="<?= $tips['interestingPage-text']; ?>"><img src="/img/icons/32/info.png"
                                                                                         style="width: 14px; height: 14px;"/></label>
                    <?php endif; ?>
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-1">
                    <?php if ($tips['frequencyPost-text']): ?>
                        <label class="control-label c_tooltip" data-delay="<?= $tips['frequencyPost-time']; ?>"
                               data-content="<?= $tips['frequencyPost-text']; ?>"><img src="/img/icons/32/info.png"
                                                                                       style="width: 14px; height: 14px;"/></label>
                    <?php endif; ?>
                </div>
            </div>
