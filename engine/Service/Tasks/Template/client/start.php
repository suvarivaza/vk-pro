...
<div class="row" style="padding-bottom: 70px;">
    <div class="col-sm-6">
        <img src="/img/main/browsers/browser-active.png" style="width: 100%"/>
    </div>
    <div class="col-sm-6">
        <h2 style="font-family: 'Proxima Nova Rg';font-size: 16pt;color: #39739b;border-bottom: 1px solid #01bcff;padding-bottom: 5px;letter-spacing: 1px;">
            Повышение активности<br>подписчиков</h2>
        <div class="main-text" style="font-size: 12pt;">
            Накручивая подписчиков через наш сервис, вы сможете
        ...
        <div class="modal-content">
            ...
            <div class="modal-body" id="i_dialog_auto_add_container">
                <form action="/orders/order" method="post">
                    ...
                    <h4 class="text-center">Приобрести Спецзадания</h4>
