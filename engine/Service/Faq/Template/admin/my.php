...
<ul class="breadcrumb">
    <li>
        ...
        <a href="/faq/my">Техническая поддержка</a>
    </li>
</ul>
<table class="table">
    <?php foreach ($list as $question): ?>
        <tr>
            <td>
                <h4 style="padding: 10px;"><?= $rubrics[$question->rubricId]->title; ?></h4>
            </td>
        </tr>
        <tr>
            <td>
                <h4 id="i_a_<?= $question->qId; ?>" style="padding: 10px;"><a id="i_a_click_<?= $question->qId; ?>"
                ...
                <div id="i_h5_<?= $question->qId; ?>" style="background-color: #ffffff; display: none; padding: 10px;">
                    ...
                    <form class="form-horizontal">
                        ...
                        <div class="form-group">
                            <div class="col-sm-12">
                                <textarea name="question" class="form-control form-span" placeholder="Текст для ответа"
                                          rows="8"></textarea>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-sm-3">
                                ...
                                <button class="c-button-done btn btn-warning" data-q-id="<?= $question->qId; ?>"
                                        type="button">Вопрос решен
                                </button>
                            </div>
                        </div>
                    </form>
